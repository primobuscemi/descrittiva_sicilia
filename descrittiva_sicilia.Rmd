...
df2 <- data.frame(tamponi_oggi,nuovi_attualmente_positivi_oggi, isolamento_domiciliare_oggi, ricoverati_con_sintomi_oggi, terapia_intensiva_oggi )
kable(df2)
...
I pazienti positivi al COVID-19 in Sicilia  sono in totale `r totale_attualmente_positivi`. Le persone positive al coronavirus in isolamento domiciliare sono `r isolamento_domiciliare`. Rispetto a ieri, sono `r isolamento_domiciliare_oggi` le persone in più in isolamento domiciliare.
...
## Totali attualmente positivi - incidenza cumulativa
