...
I nuovi casi (positivi al tampone... link alla who per definizione di caso) sono `r  nuovi_positivi`. I pazienti positivi al COVID-19 in Sicilia sono in tutto `r totali_positivi`. Le persone positive al coronavirus in isolamento domiciliare sono `r isolamento_domiciliare`. I pazienti ricoverati con sintomi sono `r ricoverati_con_sintomi`. I pazienti ricoverati in terapia intensiva sono `r terapia_intensiva`. Oggi sono decedute `r deceduti_oggi`. Le persone decedute in totale sono `r deceduti`.
