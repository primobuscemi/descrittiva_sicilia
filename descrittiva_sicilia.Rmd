...
knitr::opts_chunk$set(echo = FALSE, cache=TRUE,
                      ...
                      tidy=TRUE,WordPressLogin = c( user='filippobuscemi2020@libero.it', password='Giovi1234'),
...
knit2wp('descrittiva_sicilia.Rmd', title = 'Situazione Sicilia',publish = FALSE, action=c("newPost"))
```
