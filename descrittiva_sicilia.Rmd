...
I nuovi casi (positivi al tampone... link alla who per definizione di caso) sono `r  nuovi_attualmente_positivi`. Rispetto al bilancio della giornata di ieri, il numero delle persone risultate positive al tampone in un solo giorno è aumentato (`r nuovi_attualmente_positivi_oggi` persone in più). I pazienti positivi al COVID-19 (ospedalizzati + isolamento domiciliare) in Sicilia sono in totale `r totale_attualmente_positivi`. 
...
## Guariti
I pazienti guariti nell'ultimo giorno sono `r dimessi_guariti_oggi`. Dall'inizio dell'epidemia sono in totale `r dimessi_guariti`.
